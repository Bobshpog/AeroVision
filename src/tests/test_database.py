...
class TestDatabaseBuilder(TestCase):
    class Config:
        ...
        cameras = [
                        ...
                        [(0.04581499400545182, -0.04, -0.028567355483893577),
                         (0.05, 0.3, 0.02),
                        ...
                        [(-0.019770941905445285, -0.05, -0.038694507832388224),
                         (0.05, 0.3, 0.02),
                         (0.041, 0.0438, -1)],

                        [(-1.1317097577972088, -0.6611046370580096, 0.5827882608373682),
                         (0.05, 0.3, 0.02),
                        ...
                        [(0.021325091578885777, 0.0993123942076604, 0.3153602234842197),
                         (0.05, 1, 0.02),
