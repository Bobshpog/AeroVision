    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            for i in range(self.num_output_layers):
                ...
                self.train_batch_list[f'train_output{i}'].append(y_hat_copy[i] / self.output_scale)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            for i in range(self.num_output_layers):
                ...
                self.val_batch_list[f'val_output{i}'].append(y_hat_copy[i] / self.output_scale)
                self.val_batch_list[f'val_expected{i}'].append(y_copy[i] / self.output_scale)
